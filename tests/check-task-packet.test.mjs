...
function fields(overrides = {}) {
  return {
    ...
    cloud_secret_names: '[]', cloud_blocker: '', cloud_dispatch_status: 'not_requested',
    cloud_task_id: '', cloud_task_url: '', cloud_task_branch: '', cloud_task_commit: '',
    cloud_task_last_checked_at: '', cloud_dispatch_result: '',
