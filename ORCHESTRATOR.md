...
12. Start a separate, product-read-only `[qa][<linear_issue_key>] <short label>` companion inside the existing target project with the acceptance criteria and pinned target evidence.
